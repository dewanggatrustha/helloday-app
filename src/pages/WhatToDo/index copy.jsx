  ...
  return (
    <>
      ...
      >
        ...
        <Tabs isFitted variant="enclosed" rounded="15" boxShadow="xs" mt="10px">
          <TabList>
            <Tab>Instruction</Tab>
          ...
          <TabPanels>
            <TabPanel>
              <Accordion defaultIndex={[0]} allowMultiple>
                <AccordionItem rounded="15" boxShadow="xs" w="100%" mb="12px">
                  <h2>
                    <AccordionButton>
                    ...
                    <Flex>
                      <VStack direction="row">
                        <Image
                          ...
                          rounded="5px"
                          mr="20px"
                          src={earthquakeInformation.disaster.image[0]}
                        />
                      </VStack>
                        ...
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={earthquakeInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={earthquakeInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                      <Center flex="1">
                        <Box boxSize="2xl">
                          ...
                          <Text fontSize="md" mb="10px">
                            {earthquakeInformation.disaster.definition}
                          </Text>
                          <Box
                            bg="primary.500"
                            rounded="5px"
                          ...
                          {earthquakeInstruction.map((data) => (
                            <>
                              <UnorderedList>
                                <ListItem key={data.id} fontWeight="500">
                                  {data.name}
                                </ListItem>
                              </UnorderedList>
                              <OrderedList>
                    ...
                    <Flex>
                      <VStack direction="row">
                        <Image
                          ...
                          rounded="5px"
                          mr="20px"
                          src={tsunamiInformation.disaster.image[0]}
                        />
                      </VStack>
                      <VStack direction="column">
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={tsunamiInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={tsunamiInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                      <Center flex="1">
                        <Box boxSize="2xl">
                          ...
                          <Text fontSize="md" mb="10px">
                            {tsunamiInformation.disaster.definition}
                          </Text>
                          <Box
                            bg="primary.500"
                            rounded="5px"
                        ...
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={fireInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={fireInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                    ...
                    <Flex>
                      <VStack direction="row">
                        <Image
                          ...
                          rounded="5px"
                          mr="20px"
                          src={tornadoInformation.disaster.image[0]}
                        />
                      </VStack>
                      <VStack direction="column">
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={tornadoInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={tornadoInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                      <Center flex="1">
                        <Box boxSize="2xl">
                          ...
                          <Text fontSize="md" mb="10px">
                            {tornadoInformation.disaster.definition}
                          </Text>
                          <Box
                            bg="primary.500"
                            rounded="5px"
                        ...
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={floodInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={floodInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                    ...
                    <Flex>
                      <VStack direction="row">
                        <Image
                          ...
                          rounded="5px"
                          mr="20px"
                          src={landSlideInformation.disaster.image[0]}
                        />
                      </VStack>
                      <VStack direction="column">
                        <Center w="180px">
                          <Box boxSize="sm">
                            <Image
                              ...
                              rounded="5px"
                              mb="20px"
                              src={landSlideInformation.disaster.image[1]}
                            />
                            <Image
                              boxSize="120px"
                              objectFit="cover"
                              rounded="5px"
                              src={landSlideInformation.disaster.image[2]}
                            />
                          </Box>
                        </Center>
                      </VStack>
                      <Center flex="1">
                        <Box boxSize="2xl">
                          ...
                          <Text fontSize="md" mb="10px">
                            {landSlideInformation.disaster.definition}
                          </Text>
                          <Box
                            bg="primary.500"
                            rounded="5px"
            ...
            <TabPanel>
              <Stack direction="row" h="50px">
                <VStack align="left">
                  <Heading as="h3" size="md" fontWeight="500">
                    The following is a list of emergency calls in the event of a
                    disaster.
                  </Heading>
                </VStack>
              </Stack>
